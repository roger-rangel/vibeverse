...
export default function Banner({ setIsBannerOpen }) {
  return (
    <div className="hidden fixed bottom-0 left-0 isolate z-40 sm:flex w-full items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      <div
