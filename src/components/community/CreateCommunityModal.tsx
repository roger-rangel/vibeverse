...
export function CreateCommunity({ handleClose }: JoinCommunityProps) {
  ...
  return (
    <form
      className="fixed z-50 max-h-[calc(100%-2rem)] w-full max-w-2xl -translate-x-1/2 -translate-y-1/2 items-center justify-center overflow-y-auto rounded-lg border border-indigo-600 bg-gray-900 p-8 "
