...
export default function Learning() {
  return (
    <div
      className={
        roboto.className +
        " relative min-h-[inherit] bg-[url('https://cdn.pixelbin.io/v2/throbbing-poetry-5e04c5/original/Runway_2023-12-27T10_47_33.125Z_Infinite_Image_forest_and_wood_palace-transformed.png')] bg-cover"
      }
    >
