          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
            <div className="lg:max-w-lg items-center">
              <div className="relative lg:hidden">
                <Image src="/images/dashboard/magical_place.png" alt="logo" className="h-44 w-full rounded-2xl object-cover mb-10" width={1000} height={100} />
              </div>
                ...
                >
                  <div className="absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8 hidden lg:block">
                    <div className="flex items-center space-x-6 lg:space-x-8">
                      ...
                      <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8 mt-40 overflow-hidden h-screen animation-linear animation-infinite" style={{animationName: "moveUp", animationDuration: "5s"}}>    
                        <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-full h-full">
                          <ImageSlider images={images1} duration={4} startOffset={0} />
                        </div>                                        
                      </div>
                                          
                      <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">                       
                        <div className="absolute left-72 top-1/2 transform -translate-y-1/2 w-full h-full">
                          <ImageSlider images={images2} duration={3} startOffset={-25} />
                        </div>                     
                      </div>
